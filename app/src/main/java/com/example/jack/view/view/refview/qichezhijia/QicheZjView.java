...
public class QicheZjView  extends View{
    ...
    public QicheZjView(Context context) {
        super(context);
        init(context);
    }


    public QicheZjView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public QicheZjView(Context context, AttributeSet attrs, int defStyleAttr) {
